...
public class InvoiceReportAdapter extends BaseExpandableListAdapter {
    ...
    public InvoiceReportAdapter(Context context,
                                ArrayList<ExpListGroupItemsModel> listDataGroup,
                                ArrayList<ArrayList<ExpListChildItemsModel>> modelArrayList, boolean isSelectAll) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            ...
            mGroupViewHolder = new InvoiceReportAdapter.GroupViewHolder();
            ...
            mGroupViewHolder = (InvoiceReportAdapter.GroupViewHolder) convertView.getTag();
        }
...
//expend and collepse the list
    ...
    public ExpListChildItemsModel getChild(int groupPosition, int childPosition) {
        ...
        //return mListDataChild.get(mListDataGroup.get(groupPosition).getCompanyName()).get(childPosition);
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mChildViewHolder = new InvoiceReportAdapter.ChildViewHolder();
            ...
            mChildViewHolder = (InvoiceReportAdapter.ChildViewHolder) convertView
